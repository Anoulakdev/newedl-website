...
function privacy() {
  useEffect(() => {
    document.title = "Privacy"; // Set the page title
  ...
  return (
    <div className="container-fluid p-5" style={{ overflowY: "hidden" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to EDL APP, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Electricite Du Laos, Lao-thai friendship
            road, thongkang village, sisattanak District, Vientiane Capital,
            Laos.
          </p>
        </li>
        <li>
          <p>
            <strong>Country</strong> refers to: Laos
          </p>
        </li>
        <li>
          <p>
