...
export default function RedirectPage() {
  useEffect(() => {
    ...
    if (isHuawei) {
      link =
        "https://play.google.com/store/apps/details?id=com.edl.edl_checkin_app&pcampaignid=web_share";
    } else if (isIOS || isMac) {
      link = "https://apps.apple.com/th/app/edl-hr-checkin/id6747029905";
    } else if (isAndroid) {
      link =
        "https://play.google.com/store/apps/details?id=com.edl.edl_checkin_app&pcampaignid=web_share";
    } else {
