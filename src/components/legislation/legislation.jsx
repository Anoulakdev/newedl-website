...
const Tables = () => {
  ...
  const [itemsPerPage] = useState(5); // Configured to 5 items per page as requested
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className={`container wow tpfadeUp ${styles.legislationSection}`}>
          {/* Header Section with Search */}
          <div className={styles.headerSection}>
            <h2 className={styles.title}>ລາຍ​ການນິ​ຕິ​ກຳ</h2>
            <div className={styles.searchWrapper}>
              ...
              <input
                type="text"
                placeholder="ຄົ້ນຫານິຕິກຳ (ຫົວຂໍ້ ຫຼື ເລກທີ)..."
                    ...
                    currentItems.map((item, i) => {
                      ...
                      return (
                        <tr key={item.id || globalIndex}>
                          <td className={styles.colIndex}>{globalIndex + 1}</td>
                              ...
                              <div className="modal-dialog modal-xl modal-dialog-centered">
                                ...
                                >
                                  <div className="modal-body p-0">
                                    <iframe
                                      src={`${process.env.NEXT_PUBLIC_API_URL_IMG}/policies/${item.file_url}`}
                      ...
                      <td colSpan="5" className={styles.colIndex}>
                        <div className={styles.emptyState}>
                          <p className={styles.emptyStateTitle}>
                            ຍັງ​ບໍ່​ມີ​ຂໍ້​ມູນນິຕິກຳທີ່ທ່ານຄົ້ນຫາ
                          </p>
                        </div>
                      </td>
                    </tr>
