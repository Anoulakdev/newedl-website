                  ...
                  <div className="tp-service-4-border-top wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                     <div className="row">
                        {service_data.map((item , i) => 
                            <div key={i} className={`text-center col-xl-3 col-lg-4 col-md-6 col-6 mb-50 tp-service-4-border-right service-border-trang-${item.cls}`}>
                                <div className="tp-service-4-item z-index shadow bg-body-tertiary">
                                    ...
                                    <Link
                                        ...
                                        <div className="tp-service-4-content">
                                            ...
                                            <h4 className="tp-service-4-title text-black" style={{fontFamily: 'Noto Sans Lao'}}>{item.title}</h4>
