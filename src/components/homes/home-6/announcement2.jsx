...
const Announcement = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (results[0].status === "fulfilled")
        setData1(results[0].value.data.data);
      if (results[1].status === "fulfilled")
        setData2(results[1].value.data.data);
      if (results[2].status === "fulfilled")
        setData3(results[2].value.data.data);

      results.forEach((result, i) => {
        if (result.status === "rejected") {
          console.error(
            `Error fetching API [${endpoints[i]}]:`,
  ...
  return (
    <>
      ...
      <div id="payment-method" className="tp-payment__area pt-95">
            ...
            <div className="col-xl-12">
              <div className="row g-4">
                ...
                <div className="col-md-12">
                  <div
                    className="announcement-card card-general rounded-4 p-4 tpfadeRight p-relative z-index wow"
                    data-wow-duration=".9s"
                    data-wow-delay=".3s"
                  >
                    <div className="mb-4">
                      <h3
                        className="header-title fw-bold m-0 d-inline-flex align-items-center"
                        style={{
                ...
                <div className="col-md-12">
                  <div
                    className="announcement-card card-auction rounded-4 p-4 tpfadeLeft p-relative z-index wow"
                    data-wow-duration=".9s"
                    data-wow-delay=".5s"
                  >
                    <div className="mb-4">
                      <h3
                        className="header-title header-title-danger fw-bold m-0 d-inline-flex align-items-center"
                        style={{
                          fontFamily: "Noto Sans Lao",
                          fontSize: "1.4rem",
                        }}
                      >
                        ...
                        {validData1.length > 0 && (
                          <span
                            className="badge bg-danger rounded-pill custom-badge ms-2"
                            style={{
                              fontSize: "0.8rem",
                          ...
                          >
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                              ...
                              >
                                ...
                                ຫາ {moment(item1.end_date).format("DD-MM-YYYY")}
                              </small>
                            </div>
                          </a>
                        ))
                ...
                <div className="col-md-12">
                  <div
                    className="announcement-card card-job rounded-4 p-4 tpfadeUp p-relative z-index wow"
                    data-wow-duration=".9s"
                    data-wow-delay=".7s"
                  >
                    <div className="mb-4">
                      <h3
                        className="header-title header-title-success fw-bold m-0 d-inline-flex align-items-center"
                        style={{
                          fontFamily: "Noto Sans Lao",
                          fontSize: "1.4rem",
                        }}
                          ...
                          >
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                              ...
                              <div className="d-flex align-items-center mt-1">
                                <span
                                  className="badge bg-success bg-opacity-10 text-success rounded-pill px-2 py-1 fw-normal"
                                  style={{
                                    fontFamily: "Noto Sans Lao",
                                    fontSize: "0.75rem",
                                  }}
