...
const PriceArea = () => {
  return (
    <>
      <div className="tp-price-area pt-10 pb-80 blue-bg">
        <div className="container">
          <div className="row g-0">
            <div className="col-12">
              <div className="tp-price-sction-box text-center mb-40">
                <h3 className="tp-section-title-4 text-start">ລາ​ຄາ​ໄຟ​ຟ້າ</h3>
              </div>
            </div>
          </div>

          <div className="row g-0 col-lg-6 col-md-6">
            <ul
              className="nav nav-pills mb-4 bg-white p-3 rounded-3" 
              style={{ fontSize: "15px" }}
              id="pills-tab"
              role="tablist"
            >
